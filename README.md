...
Editor Collab **does not support** 2.2 yet. However, it is currently in the works. You can visit my [twitter](https://twitter.com/alk1m123) to get any updates on the process.

The ultimate live multiplayer editor collaboration tool! Get the [latest release (v1.12.13)](https://github.com/altalk23/EditorCollab/releases/tag/v1.12.13)! Go to [the Patreon](https://www.patreon.com/alk1m123) to be able to host levels!
